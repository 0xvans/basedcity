...
// =========================
// CONFIG
const CONTRACT_ADDRESS = '0xf63AEE54Cf271F83a031c9D006ab8B31bd461561'
      ...
      >
        <div
          style={{
            ...
            background: 'linear-gradient(90deg, #ffd59a, #ffcb77)',
          }}
        />
      </div>
    </div>
    ...
    const init = async () => {
      try {
        ...
        if (!f) {
          if (!canceled) {
            setStep('ineligible')
            setStatus('Please open the MiniApp')
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      if (ethBalance < Number(MINT_PRICE_ETH)) {
        setToast({ msg: `Insufficient ETH for gas.`, type: 'error' })
        setStep('generated')
        return
      }
  ...
  return (
    <div
      style={{
        ...
        boxShadow: '10px 10px 0 #1100ffff',
        fontFamily: 'Inter, Arial, sans-serif',
      }}
    >
      {/* Header */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
        ...
        <div style={{ display: 'flex', gap: 6 }}>
          <div style={{ width: 36, height: 36, background: '#ffffffff', borderRadius: 8, border: '2px solid #215cffff', boxShadow: '3px 3px 0 #215cffff' }} />
          <div style={{ width: 26, height: 26, background: '#ffffffff', borderRadius: 6, border: '2px solid #215cffff', boxShadow: '3px 3px 0 #215cffff' }} />
        </div>
      </div>
      ...
      <div
        style={{
          marginTop: 18,
          background: 'linear-gradient(180deg, rgba(17, 0, 255, 0.95), rgba(255, 255, 255, 0.85))',
          borderRadius: 14,
          padding: 16,
          border: '2px solid rgba(255, 255, 255, 1)',
          boxShadow: 'inset 0 -6px 0 rgba(255, 255, 255, 1)',
        }}
      >
        {/* Image Box */}
        <div
          style={{
            background: 'rgba(29, 163, 240, 0)',
            padding: 10,
            borderRadius: 12,
            border: '3px solid #ffffffff',
            boxShadow: '4px 4px 0 rgba(255, 255, 255, 0)',
          ...
          {step === 'eligible' && (
            <>
              <button
                ...
                style={{
                  ...btnStyle,
                  background: 'linear-gradient(180deg, #ffffffff, #fffcfcff)',
